...
#    Updated: 2017/05/16 09:25:32 by myernaux         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libftprintf  
SRCS = float.c ft_printf.c ft_putunbr.c hexa.c parse.c parse2.c printer_i.c adresse_printer.c ft_putlunbr.c ft_putlnbr.c
